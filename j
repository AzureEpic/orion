...
loadstring(game:HttpGet("https://github.com/AzureEpic/orion/raw/refs/heads/main/j"))()
    ]])
	else
...
local GameName = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name
	...
	Tab:AddParagraph("dc","want the dc server? go to creds")
	local InfoServer = Tab:AddSection({Name = "the server"})
	...
	ServerPlayer = Tab:AddLabel("# of players [ "..#game.Players:GetPlayers().." / "..game.Players.MaxPlayers.." ]")
	TimeServer = Tab:AddLabel("server run time [ "..math.floor(workspace.DistributedGameTime / 60 / 60).." Hour | "..math.floor(workspace.DistributedGameTime / 60) - (math.floor(workspace.DistributedGameTime / 60 / 60) * 60).." Minute | "..math.floor(workspace.DistributedGameTime) - (math.floor(workspace.DistributedGameTime / 60) * 60).." Second ]")
	TimeNow = Tab:AddLabel("ur time(?) [ "..os.date("%X").." ]")
	AgeAccYou = Tab:AddLabel("ur acc age [ "..game.Players.LocalPlayer.AccountAge.." ]")
	...
	local InfoServer = Tab:AddSection({Name = "Local Player"})
		...
		HealthYou = Tab:AddLabel("HP [ "..game.Players.LocalPlayer.Character.Humanoid.Health.." ]")
		HipHeightYou = Tab:AddLabel("Hip Height (why) [ "..game.Players.LocalPlayer.Character.Humanoid.HipHeight.." ]")
	...
	Tab:AddLabel("some things")
	Tab:AddParagraph("[ AC ]","[watch out for anticheat especially in FTAP]")
